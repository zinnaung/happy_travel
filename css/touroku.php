...
<body>
            ...
            <div class="container">
                ...
                <div class="border">
                    <form action="createuser.php" method="post">
                        ...
                        <label style="padding-right:2px;">メールアドレス再入力<input type="email" name="mail_ml_2"></label><br>
    ...
    <div class="footerlast">
        <ul class="last">
            ...
            <a><li style="margin-left: 250px;">
                Copy right(C) 2021 TSB All rights reserved.</li></a>
        </ul>
    </div>
